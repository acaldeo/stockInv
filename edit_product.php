...
<?php
 if(isset($_POST['product'])){
    $req_fields = array('product-title','product-categorie','product-quantity', 'product-stock','product-proveedor' );
   ...
   if(empty($errors)){
       ...
       $query  .=" stock_min ='{$p_stock}', proveedor_id = '{$p_prov}',categorie_id ='{$p_cat}',media_id='{$media_id}'";
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="product-stock" value="<?php echo remove_junk($product['stock_min']); ?>">
                   </div>
                  </div>
                 <!--<div class="col-md-4">
                  <div class="form-group">
